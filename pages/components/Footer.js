...
export default function Footer() {
    return (
        <footer>
            <footer class="text-gray-600 body-font details-secton  ml-2" style={{ backgroundImage: `url("../images/footer.jpg")`, backgroundRepeat: "no-repeat", backgroundSize: 'cover' }}>
                <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        ...
                        <p class="mt-2 text-sm text-gray-500 text-white">Air plant banjo lyft occupy retro adaptogen indego</p>
                    </div>
                    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                            <h2 class="title-font font-medium text-white underline tracking-widest text-sm mb-3">CATEGORIES</h2>
